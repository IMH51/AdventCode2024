...
const generateArrays = (input: string) => {
  const lines = splitStringByValue(input,'\n')
  return lines.map(line => splitStringByValue(line,''))
}

export const exampleWordsearchArrays = generateArrays(day4ExampleInput)
export const wordsearchArrays = generateArrays(day4RawInput)